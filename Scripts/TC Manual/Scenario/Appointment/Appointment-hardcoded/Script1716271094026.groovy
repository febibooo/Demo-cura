...
WebUI.selectOptionByValue(findTestObject('Object Repository/Object spy/Make appointment page/dropdown_Facility'), facility, false)

if (hospital_readmission == true) {   
	WebUI.check(findTestObject('Object Repository/Object spy/Make appointment page/dropdown_Facility'))
}
